"""Runtime-only IsaacLab scene factory for S2-03 attach-only."""
...
LEFT_PALM_SENSOR_PRIM_PATH = "{ENV_REGEX_NS}/Robot/left_hand/left_hand_palm_link"
RIGHT_PALM_SENSOR_PRIM_PATH = "{ENV_REGEX_NS}/Robot/right_hand/right_hand_palm_link"
BOX_FILTER_EXPRESSIONS = ("{ENV_REGEX_NS}/Box",)
...
def build_s2_03_env_cfg() -> G1Stage1VirtualBoxRecurrentEnvCfg:
    ...
    scene_cfg.left_palm_box_contact.update_period = env_cfg.sim.dt
    scene_cfg.right_palm_box_contact.update_period = env_cfg.sim.dt
